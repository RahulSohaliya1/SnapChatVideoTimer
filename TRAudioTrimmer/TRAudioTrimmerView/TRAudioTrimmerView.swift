...
class TRAudioTrimmerView: UIView {
    ...
    @IBOutlet weak var whiteFrameVw: UIView!
    @IBOutlet weak var yellowFrameVw: UIView!
    @IBOutlet weak var soundWaveImg: UIImageView!
    ...
    private func setupMaskView() {
        ...
        soundWaveImg.layer.cornerRadius = 8
        soundWaveImg.layer.masksToBounds = true
        
        whiteFrameVw.layer.borderWidth = 3
        whiteFrameVw.layer.borderColor = UIColor.white.cgColor
        
        whiteFrameVw.layer.cornerRadius = 8
        whiteFrameVw.layer.masksToBounds = true
        
        yellowFrameVw.layer.borderWidth = 3
        yellowFrameVw.layer.borderColor = UIColor.white.cgColor
        
        yellowFrameVw.layer.cornerRadius = 8
        yellowFrameVw.layer.masksToBounds = true
        
        
        positionBar.layer.cornerRadius = positionBar.frame.width / 3
        positionBar.layer.masksToBounds = true
        
        leftHandleView.layer.cornerRadius = leftHandleView.frame.width / 3.5
        positionBar.layer.masksToBounds = true

        leftMaskView.backgroundColor = .yellow
        leftMaskView.alpha = 0.5
        leftMaskView.translatesAutoresizingMaskIntoConstraints = false
        leftMaskView.layer.cornerRadius = 5
...
//        rightMaskView.layer.maskedCorners = [.layerMaxXMinYCorner,.layerMaxXMaxYCorner]
    ...
    private func setupGestures() {
        ...
        positionBar.addGestureRecognizer(leftPanGestureRecognizer)
    ...
    @objc func handlePanGesture(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        let isLeftGesture = view == positionBar
